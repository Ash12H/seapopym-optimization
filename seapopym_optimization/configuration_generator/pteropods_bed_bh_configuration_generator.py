...
from seapopym.model import AcidityBedBHModel
...
def pteropod_bed_bh_functional_group_unit_generator(
    ...
    return FunctionalGroupUnit(
        ...
        functional_type=FunctionalTypeParameter(
            ...
            density_dependance_parameter=functional_group.density_dependance_parameter,
        ),
    )
...
class PteropodsBedBHConfigurationGenerator:
    ...
    model_class: type[AcidityBedBHModel] = AcidityBedBHModel
